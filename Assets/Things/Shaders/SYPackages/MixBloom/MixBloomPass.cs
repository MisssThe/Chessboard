...
namespace UnityEngine.Rendering.Universal
{
    public class MixBloomPass : ScriptableRenderPass
    {
        ...
        // 设置渲染参数
        public void Setup(RenderTargetIdentifier source,MixBloom mixBloom, Material material)
        {
            m_MixBloom = mixBloom;
        ...
        void Render(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            cmd.Blit(m_Source, BloomBuffterTex[0].Identifier(), m_Material, 0);   //降分辨率，同时提取高亮
